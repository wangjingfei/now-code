...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'imaj', 154, 154, true ); 
...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<qvi pynff="nyvtayrsg">Qrfvta ol <n uers="uggc://jjj.erarubeavt.pbz/" gvgyr="jroqrfvta">jroqrfvta</n> </qvi><qvi pynff="nyvtaevtug">Gunaxf gb <n uers="uggc://jjj.erarubeavt.pbz/fhpuznfpuvarabcgvzvrehat-oreyva-frb.ugzy" gvgyr="fhpuznfpuvarabcgvzvrehat oreyva">fhpuznfpuvarabcgvzvrehat oreyva</n> | <n uers="uggc://jjj.vcsbb.qr/" gvgyr="jvr vfg zrvar vc">jvr vfg zrvar vc</n> | <n uers="uggc://jjj.sreafghqvhz-qr.qr/" gvgyr="sreafghqvhz">sreafghqvhz</n></qvi> 
...
if ( has_post_thumbnail() ) {
	 the_post_thumbnail( 'imaj', array('class' => 'entry img post-image-prelaoder') );
} else {
